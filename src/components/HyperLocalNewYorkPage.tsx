...
const SERVICES: Array<{ id: string; slug: NyServiceSlug; title: string; note: string; bookingHref: string }> = [
  { id: "home_lockout_day", slug: "emergency-locksmith", title: "Emergency locksmith", note: "Home lockout · weekday price", bookingHref: "/book/details?service_id=home_lockout_day" },
  { id: "car_lockout_at_property", slug: "car-lockout", title: "Car lockout", note: "Standard car entry", bookingHref: "/book/details?service_id=car_lockout_at_property" },
  ...
  { id: "standard_lock_change", slug: "lock-change", title: "Lock change", note: "Labor for one standard lock", bookingHref: "/book/details?service_id=standard_lock_change" },
  { id: "smart_lock_install", slug: "smart-lock-installation", title: "Smart lock installation", note: "Install your compatible smart lock", bookingHref: "/book/details?service_id=smart_lock_install" },
];
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-[1180px] px-6 sm:px-8 lg:px-10">
            ...
            <div className="mt-7 divide-y divide-[#c7d9ec] border-y border-[#c7d9ec]">
              {SERVICES.map((service) => {
                ...
                return (
                  <Link key={service.slug} href={href} className="group grid gap-3 py-4 sm:grid-cols-[1fr_auto] sm:items-center">
                    <div>
                    ...
                    <div className="flex items-center justify-between gap-5 sm:justify-end">
                      <div className="text-right">
                        ...
                        <div className="mt-1 text-[11px] text-[#536e8a]">{service.slug === "emergency-locksmith" ? "from" : "standard price"}</div>
                      </div>
        ...
        <SimpleLocalContext slug={area.slug} name={area.name} areas={area.areas} links={<LocalLinks area={area} />} />
      </main>
      <Footer />
    </div>
  );
