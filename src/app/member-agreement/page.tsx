  ...
  return (
    <LegalDoc title="Member Agreement" lastUpdated="September 5, 2026">
      <LegalSection title="1. Membership is optional and is not insurance">
        <p>Trusted Locksmith membership is an optional service-platform membership offered through TrustedLocksmithNearMe.com, a product of TSquare Ventures LLC, a Wyoming limited liability company. It is not insurance and is not a substitute for homeowners, renters, vehicle, liability, or other insurance.</p>
      </LegalSection>

      <LegalSection title="2. Operator and contact details">
        <p>TSquare Ventures LLC<br />30 N Gould St, Ste R<br />Sheridan, WY 82801<br />United States</p>
      ...
      <LegalSection title="3. Account creation is not payment activation">
      ...
      <LegalSection title="4. Digital Access">
      ...
      <LegalSection title="5. Individual plan">
      ...
      <LegalSection title="7. Household+ plan">
      ...
      <LegalSection title="8. Waiting period">
      ...
      <LegalSection title="9. Provider availability">
      ...
      <LegalSection title="10. Lock & Access Audit">
      ...
      <LegalSection title="11. Pricing and renewals">
      ...
      <LegalSection title="12. Cancellation and refunds">
      ...
      <LegalSection title="13. Relationship to the Terms of Service">
      ...
      <LegalSection title="14. Contact">
        <p>Questions about membership can be submitted through the <a href="/contact" className="text-brass hover:underline">Trusted Locksmith contact page</a> or by email at <a href="mailto:hello@trustedlocksmithnearme.com" className="text-brass hover:underline">hello@TrustedLocksmithNearMe.com</a>.</p>
      </LegalSection>
    </LegalDoc>
  );
}
