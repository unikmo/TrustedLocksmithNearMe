...
const STEPS = [
  ...
  ["02", "Send the request", "Add the Boston-area service location and the details needed to route the request."],
        ...
        <section className="border-b border-line/60">
          <div className="mx-auto grid max-w-[1180px] gap-8 px-6 py-10 sm:px-8 sm:py-14 lg:grid-cols-[.92fr_1.08fr] lg:items-center lg:gap-12 lg:px-10 lg:py-16">
            <div className="max-w-xl">
              <div className="eyebrow">Boston locksmith requests</div>
              ...
              <p className="mt-6 max-w-lg text-lg leading-8 text-parchment-dim">
                See the standard total before you request a local locksmith. No second generic call-out fee. Any extra work needs a separate price and your approval.
              </p>
            ...
            <div className="relative overflow-hidden rounded-[30px] border border-sky/18 bg-surface-raised shadow-[0_28px_70px_rgba(3,18,37,0.26)]">
              <img
                src={HERO_IMAGE}
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-void/95 via-void/55 to-transparent px-6 pb-6 pt-20">
                <div className="font-mono text-[10px] uppercase tracking-[.14em] text-brass">Boston · Greater Boston first</div>
          ...
          <div className="mx-auto max-w-[1180px] px-6 sm:px-8 lg:px-10">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div className="max-w-2xl">
                <div className="font-mono text-xs uppercase tracking-[.14em] text-[#7d6330]">Popular Boston services</div>
                <h2 className="mt-3 font-display text-4xl tracking-[-.03em] sm:text-5xl">Choose the job. See the price.</h2>
              </div>
              <Link href="/services" className="text-sm font-semibold text-navy-text hover:underline">All services & prices →</Link>
            </div>
              ...
              {featuredServices.map((service) => (
                ...
                >
                  <div>
                    ...
                    <div className="mt-1 text-sm text-[#536e8a]">{service.timing}</div>
                  </div>
                  <div className="flex items-center justify-between gap-5 sm:justify-end">
                    <div className="text-right">
                      <div className="font-display text-3xl text-[#8c6d31]">{formatServicePrice(service.customerPriceCents)}</div>
            ...
            <p className="mt-4 text-xs leading-5 text-[#536e8a]">Published standard totals include provider travel/service call. Hardware or out-of-scope work is separate only where applicable and requires approval first.</p>
          </div>
        </section>

        <section id="how-it-works" className="border-b border-line/60 py-16 sm:py-20">
          <div className="mx-auto max-w-[1180px] px-6 sm:px-8 lg:px-10">
            <div className="max-w-2xl">
        ...
        <section className="py-16 sm:py-20">
          <div className="mx-auto grid max-w-[1180px] gap-4 px-6 sm:px-8 md:grid-cols-2 lg:px-10">
            ...
            <div className="rounded-[28px] border border-line bg-surface/45 p-7 sm:p-8">
              <div className="eyebrow">Boston locksmith businesses</div>
