...
export default function TermsPage() {
  return (
    <LegalDoc title="Terms of Service" lastUpdated="September 5, 2026">
      <LegalSection title="1. Trusted Locksmith platform and operator"><p>Trusted Locksmith is a technology platform operated by TSquare Ventures LLC, 30 N Gould St Ste R, Sheridan, WY 82801, USA. The platform helps customers organize property-access information and request services from independent local providers. TSquare Ventures LLC does not itself perform locksmith, security-system, installation, repair, audit fieldwork, or other field work unless explicitly stated for a specific service.</p></LegalSection>
      ...
      <LegalSection title="12. Contact"><p>Questions about these Terms can be submitted through the Trusted Locksmith contact page or sent to TSquare Ventures LLC, 30 N Gould St Ste R, Sheridan, WY 82801, USA.</p></LegalSection>
    </LegalDoc>
  );
}
