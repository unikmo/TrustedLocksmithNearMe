...
export default function TermsPage() {
  return (
    <LegalDoc title="Terms of Service" lastUpdated="September 5, 2026">
      <LegalSection title="1. Trusted Locksmith platform and operator"><p>Trusted Locksmith is a technology platform operated by {SITE.operatorLegalDescription}, with principal / mailing address at {SITE.operatorAddressText}. The platform helps customers organize property-access information and request services from independent local providers. {SITE.operatorName} does not itself perform locksmith, security-system, installation, repair, audit fieldwork, or other field work unless explicitly stated for a specific service.</p></LegalSection>
      ...
      <LegalSection title="7. Independent providers"><p>Participating providers are independent businesses, not employees of {SITE.operatorName} or Trusted Locksmith. Providers are responsible for field work they accept, including workmanship, tools, qualifications, licenses, permits, and legal compliance applicable to that work.</p></LegalSection>
      ...
      <LegalSection title="11. Pre-launch legal completion"><p>Before unrestricted paid public launch, these operational terms should be supplemented with final governing-law provisions, payment/refund terms, provider agreement, final membership terms and any market-specific terms required for the launch jurisdictions.</p></LegalSection>
      <LegalSection title="12. Contact"><p>Questions about these Terms can be submitted through the Trusted Locksmith contact page or by email at <a href={`mailto:${SITE.operatorEmail}`} className="text-brass hover:underline">{SITE.operatorEmail}</a>. Mail may be sent to {SITE.operatorName}, {SITE.operatorAddressText}.</p></LegalSection>
    </LegalDoc>
  );
}
